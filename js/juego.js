...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 70, 410, 30, 20, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 90, 410, 30, 20, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 110, 450, 30, 20, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 130, 450, 30, 20, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 510, 210, 30, 20, 1),
    new Obstaculo('imagenes/valla_vertical.png',460,400,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png',460,420,30,30,1),
    new Obstaculo('imagenes/bache.png', 250,380,30,30,1),
    new Obstaculo('imagenes/bache.png', 500,120,30,30,1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 770,455,30,15,1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 765,115,15,30,1),
  ...
  enemigos: [
    ...
    new ZombieCaminante('imagenes/zombie1.png', 390, 135, 10, 10, 1, {
      desdeX: 170,  //rango movimiento
      hastaX: 961,
      desdeY: 120,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie1.png', 385, 120, 10, 10, 1, {
      desdeX: 170,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie1.png', 820, 245, 10, 10, 1, {
      desdeX: 170,
      hastaX: 961,
      desdeY: 130,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png', 210, 355, 10, 10, 2, {
      desdeX: 170,
      hastaX: 961,
      desdeY: 130,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie3.png', 240, 450, 10, 10, 1, {
      desdeX: 170,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
...
Juego.dibujarFondo = function() {
  ...
  // Si se gano el juego hay que mostrar el mensaje de ganoJuego de fondo
    ...
    //Dibujante.dibujarImagen('imagenes/Splash.png', 190, 113, 500, 203);
      // Control para mostrar imagen de victoria.
    $('.modal-winner').show();
    $('#msg-winner').show('slow');
    $('canvas').hide();
    $('#msg-gameover').hide();
    document.getElementById('reiniciar').style.visibility = 'visible';
  } else {
...
document.addEventListener('keydown', function(e) {
  var allowedKeys = keys; // evitar movimientos antes de que empiece el juego.
